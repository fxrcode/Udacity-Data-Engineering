...
select case when o.total >= 2000 then 'At least 2000'
			when o.total >= 1000 then 'Between 1000-2000'
			else 'less than 1000' end as total_group,
		count(*) total_group_cnt
from orders o 
group by 1
...
select a."name", SUM(o.total_amt_usd) as total_spent,
	   case when SUM(o.total_amt_usd) > 200000 then 'greater than 200000'
			when SUM(o.total_amt_usd) > 100000 then '200000 and 100000'
			else 'under 100000' end as level 
from accounts a 
join orders o 
on a.id = o.account_id 
group by 1
...
select sr.name, count(*) as total_orders, sum(o.total_amt_usd) as total_spent,
